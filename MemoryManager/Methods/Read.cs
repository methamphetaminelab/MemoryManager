...
namespace Memory
{
    public partial class Mem
    {
        ...
        {
            byte[] memory = new byte[4];
            if (ReadProcessMemory(mProc.Handle, (UIntPtr)((ulong)address + (ulong)LoadIntCode(code, file)), memory, (UIntPtr)1, IntPtr.Zero))
                return BitConverter.ToInt32(memory, 0);
            else
                return 0;
        }
        ...
        {
            byte[] memory = new byte[4];
            if (ReadProcessMemory(mProc.Handle, (UIntPtr)((ulong)address + (ulong)LoadIntCode(code, file)), memory, (UIntPtr)4, IntPtr.Zero))
            {
        ...
        public string ReadPString(UIntPtr address, string code, string file = "")
        {
            ...
            if (ReadProcessMemory(mProc.Handle, (UIntPtr)((ulong)address + (ulong)LoadIntCode(code, file)), memoryNormal, (UIntPtr)32, IntPtr.Zero))
